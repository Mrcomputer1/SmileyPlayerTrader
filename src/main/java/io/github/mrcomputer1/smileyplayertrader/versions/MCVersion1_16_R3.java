...
public class MCVersion1_16_R3 implements IMCVersion {
    ...
    public MCVersion1_16_R3(){
        try {
            // Item Stack
            Class NMS_NBTTagCompound = Class.forName("net.minecraft.server.v1_16_R3.NBTTagCompound");
            this.NMS_NBTTagCompound__CONSTRUCTOR_ = NMS_NBTTagCompound.getConstructor();

            Class NMS_NBTCompressedStreamTools = Class.forName("net.minecraft.server.v1_16_R3.NBTCompressedStreamTools");
            ...
            Class NMS_ItemStack = Class.forName("net.minecraft.server.v1_16_R3.ItemStack");
            ...
            Class OBC_CraftItemStack = Class.forName("org.bukkit.craftbukkit.v1_16_R3.inventory.CraftItemStack");
            ...
            // Merchant
            Class OBC_CraftMerchant = Class.forName("org.bukkit.craftbukkit.v1_16_R3.inventory.CraftMerchant");
            this.OBC_CraftMerchant_Instance_getMerchant_ = OBC_CraftMerchant.getMethod("getMerchant");

            Class NMS_IMerchant = Class.forName("net.minecraft.server.v1_16_R3.IMerchant");
            this.NMS_IMerchant_Instance_getOffers_ = NMS_IMerchant.getMethod("getOffers");

            Class NMS_MerchantRecipe = Class.forName("net.minecraft.server.v1_16_R3.MerchantRecipe");
            ...
            Class NMS_MerchantRecipeList = Class.forName("net.minecraft.server.v1_16_R3.MerchantRecipeList");
            ...
            Class OBC_CraftMerchantRecipe = Class.forName("org.bukkit.craftbukkit.v1_16_R3.inventory.CraftMerchantRecipe");
