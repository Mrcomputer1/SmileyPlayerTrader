...
public class MCVersion1_21_R6 implements IMCVersion {
    ...
    public MCVersion1_21_R6(World world){
        try {
            /*
             * Classes
             */
            ...
            Class<?> OBC_CraftWorld = Class.forName("org.bukkit.craftbukkit.v1_21_R6.CraftWorld");
            Class<?> OBC_CraftItemStack = Class.forName("org.bukkit.craftbukkit.v1_21_R6.inventory.CraftItemStack");
            Class<?> OBC_CraftMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R6.inventory.CraftMerchant");
            Class<?> OBC_CraftMerchantRecipe = Class.forName("org.bukkit.craftbukkit.v1_21_R6.inventory.CraftMerchantRecipe");
            Class<?> OBC_CraftInventoryMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R6.inventory.CraftInventoryMerchant");
            ...
            Method NMS_Level_Instance_registryAccess_ = NMS_Level.getMethod("L_");
            ...
            this.NMS_Merchant_Instance_getOffers_ = NMS_Merchant.getMethod("gK");
