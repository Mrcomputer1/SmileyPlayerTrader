...
public class MCVersion1_16 implements IMCVersion {
    ...
    public MCVersion1_16(){
        try {
            Class NMS_NBTTagCompound = Class.forName("net.minecraft.server.v1_16_R1.NBTTagCompound");
            this.NMS_NBTTagCompound__CONSTRUCTOR_ = NMS_NBTTagCompound.getConstructor();

            Class NMS_NBTCompressedStreamTools = Class.forName("net.minecraft.server.v1_16_R1.NBTCompressedStreamTools");
            ...
            Class NMS_ItemStack = Class.forName("net.minecraft.server.v1_16_R1.ItemStack");
            ...
            Class OBC_CraftItemStack = Class.forName("org.bukkit.craftbukkit.v1_16_R1.inventory.CraftItemStack");
