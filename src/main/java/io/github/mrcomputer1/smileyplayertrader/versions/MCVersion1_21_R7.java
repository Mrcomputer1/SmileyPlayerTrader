...
public class MCVersion1_21_R7 implements IMCVersion {
    ...
    public MCVersion1_21_R7(World world){
        try {
            /*
             * Classes
             */
            ...
            Class<?> OBC_CraftWorld = Class.forName("org.bukkit.craftbukkit.v1_21_R7.CraftWorld");
            Class<?> OBC_CraftItemStack = Class.forName("org.bukkit.craftbukkit.v1_21_R7.inventory.CraftItemStack");
            Class<?> OBC_CraftMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R7.inventory.CraftMerchant");
            Class<?> OBC_CraftMerchantRecipe = Class.forName("org.bukkit.craftbukkit.v1_21_R7.inventory.CraftMerchantRecipe");
            Class<?> OBC_CraftInventoryMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R7.inventory.CraftInventoryMerchant");
            ...
            Method NMS_Level_Instance_registryAccess_ = NMS_Level.getMethod("J_");

            // net.minecraft.nbt.NbtAccounter
            // Static Method: NMS: NbtAccounter.unlimitedHeap()
            this.NMS_NbtAccounter_Static_unlimitedHeap_ = NMS_NbtAccounter.getMethod("c");
            ...
            this.NMS_Merchant_Instance_getOffers_ = NMS_Merchant.getMethod("b");
            ...
            this.NMS_MerchantContainer_Instance_getActiveOffer_ = NMS_MerchantContainer.getMethod("h");
