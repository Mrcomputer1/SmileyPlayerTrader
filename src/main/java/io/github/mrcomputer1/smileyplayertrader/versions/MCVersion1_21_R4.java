...
public class MCVersion1_21_R4 implements IMCVersion {
    ...
    public MCVersion1_21_R4(World world){
        try {
            // World
            Class<?> NMS_HolderLookup$a = Class.forName("net.minecraft.core.HolderLookup$a");

            Class<?> OBC_CraftWorld = Class.forName("org.bukkit.craftbukkit.v1_21_R4.CraftWorld");
            ...
            Class<?> OBC_CraftItemStack = Class.forName("org.bukkit.craftbukkit.v1_21_R4.inventory.CraftItemStack");
            ...
            Class<?> OBC_CraftMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R4.inventory.CraftMerchant");
            ...
            this.NMS_IMerchant_Instance_getOffers_ = NMS_IMerchant.getMethod("gw");
            ...
            Class<?> OBC_CraftMerchantRecipe = Class.forName("org.bukkit.craftbukkit.v1_21_R4.inventory.CraftMerchantRecipe");
            ...
            Class<?> OBC_CraftInventoryMerchant = Class.forName("org.bukkit.craftbukkit.v1_21_R4.inventory.CraftInventoryMerchant");
